...
class thank(commands.Cog):
  ...
  async def on_message(self, message):
        help_channels = (812421593707315231, 807226238896570429, 807226384246243348, 807226722491039754, 807226820113989682, 807226846897897482, 807226904566038578, 807227165363273749, 807227353272025098, 807227320788189204, 807227224445026335, 807314465175502848, 807227660429557781, 807227701890514975, 807227761298374686, 808948498049138710, 807228003616030720, 807228044397117441, 807228325562548284, 807228024214913074, 807228361373908992, 807306277033082900, 807306248986165248, 807306261442985995, 807579568620830766, 80730630100864206)
        result = re.match('(?<!\w)(?:t(?:han[qk]s*|(?:hn?|h?n)x+|y(?:[sv]m)?)|danke)(?!\w)', message.content.lower()) and message.channel.id in help_channels
        if result:
